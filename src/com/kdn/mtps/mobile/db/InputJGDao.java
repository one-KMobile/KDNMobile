...
public class InputJGDao extends BaseDao{
	...
	public void Append(JGInfo row, int idx) {
		...
		updateRow.put(JGInfo.COLS.C1_JS, row.c1_js);
		updateRow.put(JGInfo.COLS.C1_JSJ, row.c1_jsj);
		updateRow.put(JGInfo.COLS.C1_YB_RESULT, row.c1_yb_result);
		updateRow.put(JGInfo.COLS.C1_POWER_NO, row.c1_power_no);
		updateRow.put(JGInfo.COLS.C2_JS, row.c2_js);
		updateRow.put(JGInfo.COLS.C2_JSJ, row.c2_jsj);
		updateRow.put(JGInfo.COLS.C2_YB_RESULT, row.c2_yb_result);
		updateRow.put(JGInfo.COLS.C2_POWER_NO, row.c2_power_no);
		updateRow.put(JGInfo.COLS.C3_JS, row.c3_js);
		updateRow.put(JGInfo.COLS.C3_JSJ, row.c3_jsj);
		updateRow.put(JGInfo.COLS.C3_YB_RESULT, row.c3_yb_result);
		updateRow.put(JGInfo.COLS.C3_POWER_NO, row.c3_power_no);
...
//		dbCheck();
	...
	public ArrayList<JGInfo> selectJG(String mIdx) {
		...
		try {
			...
			while (cursor.moveToNext()) {
				...
				String c1_js = cursor.getString(cursor.getColumnIndex(JGInfo.COLS.C1_JS));
				String c1_jsj = cursor.getString(cursor.getColumnIndex(JGInfo.COLS.C1_JSJ));
				String c1_yb_result = cursor.getString(cursor.getColumnIndex(JGInfo.COLS.C1_YB_RESULT));
				String c1_power_no = cursor.getString(cursor.getColumnIndex(JGInfo.COLS.C1_POWER_NO));
				String c2_js = cursor.getString(cursor.getColumnIndex(JGInfo.COLS.C2_JS));
				String c2_jsj = cursor.getString(cursor.getColumnIndex(JGInfo.COLS.C2_JSJ));
				String c2_yb_result = cursor.getString(cursor.getColumnIndex(JGInfo.COLS.C2_YB_RESULT));
				String c2_power_no = cursor.getString(cursor.getColumnIndex(JGInfo.COLS.C2_POWER_NO));
				String c3_js = cursor.getString(cursor.getColumnIndex(JGInfo.COLS.C3_JS));
				String c3_jsj = cursor.getString(cursor.getColumnIndex(JGInfo.COLS.C3_JSJ));
				String c3_yb_result = cursor.getString(cursor.getColumnIndex(JGInfo.COLS.C3_YB_RESULT));
				String c3_power_no = cursor.getString(cursor.getColumnIndex(JGInfo.COLS.C3_POWER_NO));
