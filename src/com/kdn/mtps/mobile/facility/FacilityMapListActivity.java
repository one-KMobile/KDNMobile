...
public class FacilityMapListActivity extends NMapActivity implements TitleManager{
...
//		FacilityInfo Info = intent.getParcelableExtra("locations");
//		mLocations = Info.getArrLocation();
		
		facList = (ArrayList<FacilityInfo>) intent.getSerializableExtra("locations");
		...
		if (mMyLocationOverlay != null) {
			...
			if (mMapLocationManager.isMyLocationEnabled()) {
				...
				if (!isMyLocationEnabled) {
					Toast.makeText(FacilityMapListActivity.this, "Please enable a My Location source in system settings",
...
//				item.setRightAccessory(true, NMapPOIflagType.CLICKABLE_ARROW);
//			} else 
			poiData.addPOIitem(dLong.doubleValue(), dLat.doubleValue(), info.EQP_NM, markerId, info);
		}
		poiData.endPOIdata();
...
//		poiDataOverlay.selectPOIitem(0, true);
	...
	private final NMapActivity.OnDataProviderListener onDataProviderListener = new NMapActivity.OnDataProviderListener() {
		...
		public void onReverseGeocoderResponse(NMapPlacemark placeMark, NMapError errInfo) {
			...
			if (errInfo != null) {
				...
				Toast.makeText(FacilityMapListActivity.this, errInfo.toString(), Toast.LENGTH_LONG).show();
				return;
			}
	...
	private final NMapLocationManager.OnLocationChangeListener onMyLocationChangeListener = new NMapLocationManager.OnLocationChangeListener() {
		...
		public void onLocationUpdateTimeout(NMapLocationManager locationManager) {
			...
			Toast.makeText(FacilityMapListActivity.this, "Your current location is temporarily unavailable.", Toast.LENGTH_LONG).show();
		}

		@Override
		public void onLocationUnavailableArea(NMapLocationManager locationManager, NGeoPoint myLocation) {

			Toast.makeText(FacilityMapListActivity.this, "Your current location is unavailable area.", Toast.LENGTH_LONG).show();
	...
	private final NMapView.OnMapStateChangeListener onMapViewStateChangeListener = new NMapView.OnMapStateChangeListener() {
		...
		public void onMapInitHandler(NMapView mapView, NMapError errorInfo) {
			...
			if (errorInfo == null) { // success
				...
				Toast.makeText(FacilityMapListActivity.this, errorInfo.toString(), Toast.LENGTH_LONG).show();
			}
		}
...
//			Toast.makeText(FacilityMapListActivity.this, "onCalloutClick: " + item.getTitle(), Toast.LENGTH_LONG).show();
			...
			if (itemOverlay instanceof NMapPOIdataOverlay) {
				...
				if (!poiDataOverlay.isFocusedBySelectItem()) {
					...
					if (countOfOverlappedItems > 1) {
						...
						Toast.makeText(FacilityMapListActivity.this, text, Toast.LENGTH_LONG).show();
						return null;
					}
				}
			}
	...
	private final NMapOverlayManager.OnCalloutOverlayViewListener onCalloutOverlayViewListener = new NMapOverlayManager.OnCalloutOverlayViewListener() {
		...
		public View onCreateCalloutOverlayView(NMapOverlay itemOverlay, NMapOverlayItem overlayItem, Rect itemBounds) {
			...
			if (overlayItem != null) {
				...
				if (title != null) {
					return new NMapCalloutCustomOverlayView(FacilityMapListActivity.this, itemOverlay, overlayItem, itemBounds, ConstVALUE.MODE_MAPVIEW_ALL);
				}
			}
	...
	public void setTitle() {
		...
		btnHeaderTitle.setText(getString(R.string.title_facility_map_list));
		...
		btnHeaderRight.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				AppUtil.startActivity(FacilityMapListActivity.this, new Intent(FacilityMapListActivity.this, MainActivity.class));
			}
		});
	}
