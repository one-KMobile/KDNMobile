...
public class JGPSubInfo implements Parcelable {
	public int IDX;
	...
	private JGPSubInfo(Parcel source) {
	...
	public  static final Creator<JGPSubInfo> CREATOR
	= new Creator<JGPSubInfo>() {

		@Override
		public JGPSubInfo createFromParcel(Parcel source) {
			// TODO Auto-generated method stub
			return new JGPSubInfo(source);
		}

		@Override
		public JGPSubInfo[] newArray(int size) {
			// TODO Auto-generated method stub
			return new JGPSubInfo[size];
		}
	};
