...
public class JSInfo implements Parcelable {
	...
	public  static final Parcelable.Creator<JSInfo> CREATOR
	= new Parcelable.Creator<JSInfo>() {

		@Override
		public JSInfo createFromParcel(Parcel source) {
			// TODO Auto-generated method stub
			return new JSInfo(source);
		}
