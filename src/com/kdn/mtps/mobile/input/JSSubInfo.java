...
public class JSSubInfo implements Parcelable {
	public int IDX;
	...
	private JSSubInfo(Parcel source) {
	...
	public  static final Parcelable.Creator<JSSubInfo> CREATOR
	= new Parcelable.Creator<JSSubInfo>() {

		@Override
		public JSSubInfo createFromParcel(Parcel source) {
			// TODO Auto-generated method stub
			return new JSSubInfo(source);
		}

		@Override
		public JSSubInfo[] newArray(int size) {
			// TODO Auto-generated method stub
			return new JSSubInfo[size];
		}
	};
