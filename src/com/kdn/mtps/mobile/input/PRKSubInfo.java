...
public class PRKSubInfo implements Parcelable {
	public int IDX;
	...
	private PRKSubInfo(Parcel source) {
	...
	public  static final Creator<PRKSubInfo> CREATOR
	= new Creator<PRKSubInfo>() {

		@Override
		public PRKSubInfo createFromParcel(Parcel source) {
			// TODO Auto-generated method stub
			return new PRKSubInfo(source);
		}

		@Override
		public PRKSubInfo[] newArray(int size) {
			// TODO Auto-generated method stub
			return new PRKSubInfo[size];
		}
	};
