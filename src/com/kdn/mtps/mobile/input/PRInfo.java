...
public class PRInfo implements Parcelable {
	public int idx;
	...
	public  static final Creator<PRInfo> CREATOR
	= new Creator<PRInfo>() {

		@Override
		public PRInfo createFromParcel(Parcel source) {
			// TODO Auto-generated method stub
			return new PRInfo(source);
		}

		@Override
		public PRInfo[] newArray(int size) {
			// TODO Auto-generated method stub
			return new PRInfo[size];
		}
	};
