...
public class JGUInfo implements Parcelable {
	public int idx;
	...
	public  static final Creator<JGUInfo> CREATOR
	= new Creator<JGUInfo>() {

		@Override
		public JGUInfo createFromParcel(Parcel source) {
			// TODO Auto-generated method stub
			return new JGUInfo(source);
		}

		@Override
		public JGUInfo[] newArray(int size) {
			// TODO Auto-generated method stub
			return new JGUInfo[size];
		}
	};
