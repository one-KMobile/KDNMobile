...
public class JGSubInfo implements Parcelable {
	public int IDX;
	...
	private JGSubInfo(Parcel source) {
	...
	public  static final Creator<JGSubInfo> CREATOR
	= new Creator<JGSubInfo>() {

		@Override
		public JGSubInfo createFromParcel(Parcel source) {
			// TODO Auto-generated method stub
			return new JGSubInfo(source);
		}

		@Override
		public JGSubInfo[] newArray(int size) {
			// TODO Auto-generated method stub
			return new JGSubInfo[size];
		}
	};
